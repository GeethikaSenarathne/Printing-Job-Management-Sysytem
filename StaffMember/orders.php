...
<div class="content">
  ...
  <!---getting user datails from the database--->
		<table>
			...
			<?php 
				$sql="SELECT orders.o_id,customers.name,orders.product,orders.Status,orders.req_date,orders.delivery_date FROM orders, customers WHERE orders.customerID = customers.NIC";
