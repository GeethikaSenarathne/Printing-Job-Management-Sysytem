...
<head>
<script>
	document.getElementById('id2').style.backgroundColor = "#88304e";
function myFunction() {
...
<div class="content">
	<div class="main">
		<h1>Customers</h1>
  		<div class="dropdown">
			<button type="button" class="dropbtn" data-toggle="modal" data-target="#addCustomer"> Add Customer</button> 
		</div>
		<input type="text" id="myInput" name="text1" onkeyup="myFunction()" placeholder="Search for Customer.." title="Type in a name">
  ...
  <!---getting user datails from the database--->
		<table id="myTable">
			...
			<?php 
				$sql="SELECT NIC,name,address,contact_no, email FROM customers";
			         ...
			         <form method="post">
			        	<div class="modal-body">
					        ...
					        <div class="modal-footer">
					        	<button type="submit" class="btn btn-default" name="addCustomer">Add Customer</button>
...
<!---send customer details to database--->
	<?php
		if(isset($_POST['addCustomer'])){
			...
			$query="INSERT INTO customers(NIC,name,address,contact_no,email,password) VALUES('{$nic}','{$name}','{$address}','{$contact_no}','{$email}','{$nic}')";
