...
$sql="SELECT `id`, `name`, `email`, `product`, `productSize`, `quantity`, `sample`,`unitPrice`,`description`,`otherCharges`,`Price` FROM `qoute` WHERE id='".$id."'";
...
<table width="100%">
    <thead>
      ...
      <p><h4>
      Quatation ID: $id <br><br>
      Quotation for;<br>
      $name</p><br>
      Date : $date</h4>

<br><br><br><br><br><br>
<h1 class="title">Quotation</i></h1>
<br><br><br><br>
